  <div class="card-deck  px-3 py-3 pt-md-5 pb-md-4 mx-auto">
    ...
    <div class="col-md-9">
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <form action="<?= base_url(); ?>index.php/user/simpanJawaban/2/<?= $session['id'] ?>" id="frmSoal" method='POST' > 
            <?php 
              $nomor = 1;
            ...
            <div class="row">
              <div class="col-md-12 ml-5">
                <table>
                  ...
                  <div class="ml-4">
                    <label>
                      <input type="radio" name="jawaban[<?= $data['id']; ?>]" value="A" class="icek">
                  ...
                  <div class="ml-4">
                    <label>
                      <input type="radio" name="jawaban[<?= $data['id']; ?>]" value="B" class="icek">
                  ...
                  <div class="ml-4">
                    <label>
                      <input type="radio" name="jawaban[<?= $data['id']; ?>]" value="C" class="icek">
                  ...
                  <div class="ml-4">
                    <label>
                      <input type="radio" name="jawaban[<?= $data['id']; ?>]" value="D" class="icek">
   ...
   <!-- <script src="<?= base_url();  ?>assets/time.js"></script> -->
