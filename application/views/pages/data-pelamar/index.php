            ...
            <div class="box-header with-border">
              <h3 class="box-title "><?= $judul ?></h3>
                <div class="tombol-kanan">
                  <a href="<?= base_url(); ?>index.php/admin/tambahPelamar" class="btn btn-default btn-sm">&nbsp;<i class="fa fa-lg  fa-user"></i>&nbsp; Tambah User&nbsp;</a>
                 ...
                 ?>
                  <tr>
                    ...
                    <td class="align-middle text-center">
                      <a href="<?= base_url(); ?>index.php/admin/editPelamar/<?= $data['id']; ?>"
                         class="btn btn-success btn-sm">&nbsp;<i class="fa fa-lg  fa-pencil"></i> Edit</a>
                      <a href="<?= base_url(); ?>index.php/admin/hapusPelamar/<?= $data['id']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini ?')" 
